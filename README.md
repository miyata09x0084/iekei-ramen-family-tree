...
吉村家を頂点に、関東・東海・関西の家系ラーメン45店・7世代の修行系譜を、縦書き屋号の伝統的な系図様式で辿れる Web アプリです。名古屋・大阪・京都・神戸の店からも、吉村家までの道筋を辿れます。
...
| 系統・地方で絞る | 上部のチップ（直系 / 本牧家系 / 六角家系 … 、関東 / 東海 / 関西）を押す |
| 屋号で探す | 左上の検索欄に入力 |
...
系譜は公開情報を編集したものです。創業年は概算（「頃」表記）を含み、系譜上の位置づけに諸説ある店は点線で示しています。東海・関西の店をどう調べて収録したかは [`docs/research-tokai-kansai.md`](docs/research-tokai-kansai.md) に残しています。誤りや追加したい店があれば [Issue](https://github.com/miyata09x0084/iekei-ramen-family-tree/issues) でお知らせください。
